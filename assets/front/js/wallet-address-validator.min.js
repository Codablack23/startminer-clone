      ...
      1: [
        function (t, r, e) {
          ...
          r.exports = function (u) {
            for (
              var a = {}, f = u.length, h = u.charAt(0), t = 0;
              t < u.length;
              t++
            ) {
              var r = u.charAt(t);
            ...
            function e(t) {
              ...
              for (var r = [0], e = 0; e < t.length; e++) {
                var n = a[t[e]];
                if (void 0 === n) return;
                for (var i = 0, o = n; i < r.length; ++i)
                  (o += r[i] * f), (r[i] = 255 & o), (o >>= 8);
            ...
            return {
              encode: function (t) {
                ...
                for (var r = [0], e = 0; e < t.length; ++e) {
                  for (var n = 0, i = t[e]; n < r.length; ++n)
                    (i += r[n] << 8), (r[n] = i % f), (i = (i / f) | 0);
                  for (; 0 < i; ) r.push(i % f), (i = (i / f) | 0);
                }
                for (var o = "", s = 0; 0 === t[s] && s < t.length - 1; ++s)
                  o += h;
          ...
          (e.byteLength = function (t) {
            ...
            (e.toByteArray = function (t) {
              ...
              for (r = 0; r < e; r += 4)
                (n =
                  (f[t.charCodeAt(r)] << 18) |
                  (f[t.charCodeAt(r + 1)] << 12) |
                  (f[t.charCodeAt(r + 2)] << 6) |
                  f[t.charCodeAt(r + 3)]),
                  (o[a++] = (n >> 16) & 255),
                  (o[a++] = (n >> 8) & 255),
                  (o[a++] = 255 & n);
              2 === i
                ? ((n =
                    (f[t.charCodeAt(r)] << 2) | (f[t.charCodeAt(r + 1)] >> 4)),
                  (o[a++] = 255 & n))
                : 1 === i &&
                  ((n =
                    (f[t.charCodeAt(r)] << 10) |
                    (f[t.charCodeAt(r + 1)] << 4) |
                    (f[t.charCodeAt(r + 2)] >> 2)),
                  (o[a++] = (n >> 8) & 255),
                  (o[a++] = 255 & n));
              return o;
            }),
      ...
      3: [
        function (t, r, e) {
          ...
          function g(t, r, e, n, i) {
            ...
            if (("string" == typeof r && (r = c.from(r, n)), c.isBuffer(r)))
          ...
          function m(t, r, e) {
            ...
            return (function (t) {
              ...
              var e = "",
                n = 0;
              for (; n < r; )
                e += String.fromCharCode.apply(String, t.slice(n, (n += _)));
              return e;
            })(n);
          }
          (e.kMaxLength = i),
            ...
            (c.concat = function (t, r) {
              ...
              for (e = 0; e < t.length; ++e) {
                var o = t[e];
                if ((ArrayBuffer.isView(o) && (o = c.from(o)), !c.isBuffer(o)))
                  throw new TypeError(
                    '"list" argument must be an Array of Buffers'
                  );
            ...
            (c.prototype.write = function (t, r, e, n) {
              ...
              for (var o, s, a, u, f, h, c, l, p, d = !1; ; )
                switch (n) {
                  ...
                  case "utf-8":
                    return (
                      (l = r), (p = e), M(L(t, (c = this).length - l), c, l, p)
                    );
                  case "ascii":
                    return w(this, t, r, e);
                  case "latin1":
          ...
          (c.prototype.slice = function (t, r) {
            ...
            (c.prototype.readUIntBE = function (t, r, e) {
              (t >>>= 0), (r >>>= 0), e || k(t, r, this.length);
              for (var n = this[t + --r], i = 1; 0 < r && (i *= 256); )
                n += this[t + --r] * i;
              return n;
            }),
            ...
            (c.prototype.readIntBE = function (t, r, e) {
              (t >>>= 0), (r >>>= 0), e || k(t, r, this.length);
              for (var n = r, i = 1, o = this[t + --n]; 0 < n && (i *= 256); )
                o += this[t + --n] * i;
                ...
                r = Math.abs(r),
                  isNaN(r) || r === 1 / 0
                    ...
                    : ((s = Math.floor(Math.log(r) / Math.LN2)),
                      ...
                      2 <=
                        (r += 1 <= s + c ? l / u : l * Math.pow(2, 1 - c)) *
                          u && (s++, (u /= 2)),
                      h <= s + c
                        ? ((a = 0), (s = h))
                        : 1 <= s + c
                        ? ((a = (r * u - 1) * Math.pow(2, i)), (s += c))
        ...
        function (t, i, o) {
          ...
          !(function (t) {
            function r(s, t, r) {
              ...
              if (
                ((i = (r = r || {}).encoding || "UTF8"),
                (d = r.numRounds || 1) !== parseInt(d, 10) || d < 1)
              )
                throw Error("numRounds must a integer >= 1");
              if (0 !== s.lastIndexOf("SHA-", 0))
                ...
                (l = function (t, r, e, n) {
                  ...
                  for (
                    t[r >>> 5] |= 128 << (24 - (r % 32)),
                      r += e,
                      t[i] = 4294967295 & r,
                      t[i - 1] = (r / 4294967296) | 0,
                      e = t.length,
                      r = 0;
                    r < e;
                    r += o
                  )
                    n = F(t.slice(r, r + o), n, s);
                  if ("SHA-224" === s)
              ...
              (u = k(t, i)),
                ...
                (this.setHMACKey = function (t, r, e) {
                  ...
                  for (t = 0; t <= e; t += 1)
                    (o[t] = 909522486 ^ r[t]), (b[t] = 1549556828 ^ r[t]);
                  (a = c(o, a)), (g = h), (w = !0);
                }),
                ...
                (this.getHash = function (t, r) {
                  ...
                  for (o = l(y.slice(), v, g, p(a)), n = 1; n < d; n += 1)
                    o = l(o, f, 0, H(s));
                  return e(o);
                }),
            ...
            function x(t, r) {
              var e,
                ...
                i = r / 8,
                o = new ArrayBuffer(i);
              for (n = new Uint8Array(o), e = 0; e < i; e += 1)
                n[e] = (t[e >>> 2] >>> (8 * (3 + (e % 4) * -1))) & 255;
              return o;
            }
            ...
            function B(t) {
              ...
              if (
                ...
                !0 === t.hasOwnProperty("b64Pad") && (r.b64Pad = t.b64Pad),
                "boolean" != typeof r.outputUpper)
              )
                ...
                case "HEX":
                  r = function (t, r, e) {
                    ...
                    for (
                      ...
                      if (((i = parseInt(t.substr(n, 2), 16)), isNaN(i)))
                        throw Error(
                          "String of HEX type contains invalid characters"
                        );
                      for (o = (s = (n >>> 1) + a) >>> 2; r.length <= o; )
                        r.push(0);
                      r[o] |= i << (8 * (3 + (s % 4) * -1));
                    }
                    return {
                ...
                case "B64":
                  r = function (t, r, e) {
                    ...
                    for (
                      ...
                      for (a = t.substr(i, 4), o = s = 0; o < a.length; o += 1)
                        s |=
                          (n =
            ...
            function F(t, r, e) {
              ...
              for (
                ...
                p < 16
                  ? ((c = p * d),
                    (h = t.length <= c ? 0 : t[c]),
                    (c = t.length <= c + 1 ? 0 : t[c + 1]),
                    (k[p] = new x(h, c)))
                  : (k[p] = y(b(k[p - 2]), k[p - 7], w(k[p - 15]), k[p - 16])),
                  (h = v(f, _(s), A(s, a, u), B[p], k[p])),
                  (c = g(m(e), E(e, n, i))),
                  (f = u),
                  (u = a),
                  (a = s),
            ...
            (N = [
              ...
              void 0 !== o
                ? (void 0 !== i && i.exports && (i.exports = r), (o = r))
                : (t.jsSHA = r);
          })(this);
        },
        {},
              ...
              (f = null),
                ...
                (function (r) {
                  ...
                  if ((i === a || !i) && clearTimeout)
                    return (i = clearTimeout), clearTimeout(r);
                  try {
                    i(r);
                  } catch (t) {
                    try {
            ...
            if (i) {
              ...
              return o !== e
                ...
                : a.toHex(i.slice(o - 4, o)) ===
                  ...
                  })(n, a.toHex(i.slice(0, o - 4)))
                ? a.toHex(i.slice(0, e - 24))
                : null;
            }
            return null;
          }
                ...
                (function (t, r, e) {
                  ...
                  return (
                    ...
                    0 <=
                      ("prod" === e || "testnet" === e
                        ? r.addressTypes[e]
                        : r.addressTypes.prod.concat(r.addressTypes.testnet)
                      ).indexOf(n)
                  );
            ...
            decode: function (t) {
              ...
              for (r = 0; r < t.length; ++r) {
                ...
                for (e = 0; e < n.length; ++e)
                  (n[e] += o), (o = n[e] >> 8), (n[e] &= 255);
                for (; o; ) n.push(255 & o), (o >>= 8);
              }
              for (r = 0; "1" === t[r] && r < t.length - 1; ++r) n.push(0);
              return n.reverse();
            },
          };
        },
          ...
          r.exports = {
            decode: function (t) {
              ...
              for (r = 0; r < t.length; ++r) {
                ...
                97 <= t.charCodeAt(r) && t.charCodeAt(r) <= 122 && (e = !0),
                  65 <= t.charCodeAt(r) && t.charCodeAt(r) <= 90 && (n = !0);
              }
              if (e && n) return null;
              ...
              for (
                var e = r.concat(
                    (function (t, r) {
                      for (
                        var e =
                            1 ^ c(l(t).concat(r).concat([0, 0, 0, 0, 0, 0])),
                          n = [],
                          i = 0;
                        i < 6;
                        ++i
      ...
      11: [
        function (t, r, e) {
          !(function (t) {
            ...
            function g(t, r, e) {
              if (e !== d)
                return t instanceof g ? t : void 0 === t ? v : g.parse(t);
            ...
            (g.M_ONE = b),
              ...
              (g.digits = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")),
              (g.prototype.toString = function (t) {
                ...
                if (10 === t) {
                  ...
                  for (var e = this._d.length - 2; 0 <= e; e--) {
                    for (var n = this._d[e].toString(); n.length < 7; )
                      n = "0" + n;
                    r += n;
                  }
                  return r;
              ...
              (g.parse = function (t, r) {
                ...
                if (n) {
                  ...
                  if (void 0 === r)
                    ...
                    throw new Error("Illegal radix " + r + ".");
                  if (!g.radixRegex[(r = +r)].test(s))
                    throw new Error("Bad digit for radix " + r);
                  if (0 === (s = s.replace(/^0+/, "").split("")).length)
                    return v;
                  if (((i = "-" === i ? -1 : 1), 10 == r)) {
                    for (var a = []; 7 <= s.length; )
                      a.push(
                        parseInt(
                          s
                            .splice(s.length - g.base_log10, g.base_log10)
                            .join(""),
                          10
                        )
                      );
                  ...
                  a = v;
                  r = g.small[r];
                  for (var u = g.small, f = 0; f < s.length; f++)
                    a = a.multiply(r).add(u[parseInt(s[f], 36)]);
              ...
              (g.prototype.add = function (t) {
                ...
                for (
                  ...
                  (r = e[f] + n[f] + u), (s[f] = r % y), (u = (r / y) | 0);
                for (i < o && ((e = n), (i = o)), f = a; u && f < i; f++)
                  (r = e[f] + u), (s[f] = r % y), (u = (r / y) | 0);
              ...
              (g.prototype.subtract = function (t) {
                ...
                var r = this;
                this._s < 0 &&
                  ((r = new g(t._d, 1, d)), (t = new g(this._d, 1, d)));
              ...
              (g.prototype.multiply = function (t) {
                ...
                for (r = 0; r < a; r++) u[r] = 0;
                for (r = 0; r < s; r++) {
                  for (var f, h = 0, c = i[r], l = o + r, p = r; p < l; p++)
                    (h = ((f = u[p] + c * n[p - r] + h) / y) | 0),
                      (u[p] = f % y | 0);
              ...
              (g.prototype.square = function () {
                ...
                for (n = 0; n < o; n++) {
                  (r = 0), (e = 2 * n + 1);
                  for (var a = n + 1; a < o; a++, e++)
                    (r = ((t = i[a] * i[n] * 2 + s[e] + r) / y) | 0),
                      (s[e] = t % y);
                  var u = r + s[(e = o + n)];
              ...
              (g.prototype.divide = g.prototype.quotient =
                function (t) {
              ...
              (g.prototype.divRem = function (t) {
                ...
                for (
                  ...
                  if (
                    (a._d.unshift(i[--o]),
                    (a = new g(a._d, 1, d)).compareAbs(t) < 0)
                  )
                    s.push(0);
                  else {
                    if (0 === a._s) r = 0;
                      ...
                      a._d.length > n._d.length && (h = (h + 1) * y),
                        (r = Math.ceil(h / c));
                    }
                    do {
              ...
              (g.prototype.divRemSmall = function (t) {
                ...
                var e = t < 0 ? -1 : 1,
                  n = this._s * e;
                if ((t = Math.abs(t)) < 1 || y <= t)
                  throw new Error("Argument out of range");
                if (0 === this._s) return [v, v];
                if (1 === t || -1 === t)
                  return [1 === n ? this.abs() : new g(this._d, n, d), v];
                if (1 === this._d.length) {
                  var i = new g([(this._d[0] / t) | 0], 1, d);
                  return (
                    (r = new g([this._d[0] % t | 0], 1, d)),
                    n < 0 && (i = i.negate()),
                ...
                for (
                  ...
                  if ((u = u * y + s[s.length - 1]) < t)
                    (a[h++] = 0), s.pop(), (f = y * f + u);
                  else
                    (f = u - t * (o = 0 === u ? 0 : (u / t) | 0)),
                      (a[h++] = o) ? (s.pop(), (u = f)) : s.pop();
                }
                return (
                  (r = new g([f], 1, d)),
                  this._s < 0 && (r = r.negate()),
                  [new g(a.reverse(), n, d), r]
                );
              }),
              ...
              (g.prototype.exp10 = function (t) {
                ...
                if (0 < t) {
                  for (
                    var r = new g(this._d.slice(), this._s, d);
                    7 <= t;
                    t -= 7
                  )
                    r._d.unshift(0);
                  return 0 == t
                    ? r
                    : ((r._s = 1),
                      (r = r.multiplySingleDigit(Math.pow(10, t))),
                      this._s < 0 ? r.negate() : r);
                }
              ...
              (g.prototype.modPow = function (t, r) {
                for (var e = w, n = this; t.isPositive(); )
                  t.isOdd() && (e = e.multiply(n).remainder(r)),
                    (t = t.quotient(g.small[2])).isPositive() &&
                      (n = n.square().remainder(r));
                return e;
              }),
              (g.prototype.log = function () {
                ...
                var r = Math.ceil(30 / 7),
                  e = this._d.slice(t - r);
                return (
                  Math.log(new g(e, 1, d).valueOf()) + (t - r) * Math.log(y)
                );
              }),
              ...
              (function () {
                ...
                !(function () {
                  ...
                  for (t = 0; t < e.length; t++)
                    g[(r = e[t])] = o(g.prototype[r]);
                  for (t = 0; t < n.length; t++)
                    g[(r = n[t])] = s(g.prototype[r]);
                  for (t = 0; t < i.length; t++)
                    g[(r = i[t])] = a(g.prototype[r]);
        ...
        function (t, e, r) {
          (function (o) {
            ...
            (c.sigma = [
              ...
              (c.prototype._length_carry = function (t) {
                for (var r = 0; r < t.length && !(t[r] < 4294967296); ++r)
                  (t[r] -= 4294967296), (t[r + 1] += 1);
              }),
              (c.prototype.update = function (t, r) {
                t = new o(t, r);
                for (
                  var e = this._block, n = 0;
                  this._blockOffset + t.length - n >= e.length;
            ...
            function i(t, r, e, n, i, o, s, a) {
              var u = c.sigma,
                f = c.u256;
              (t[n] =
                (t[n] + ((r[u[e][a]] ^ f[u[e][a + 1]]) >>> 0) + t[i]) >>> 0),
                (t[s] = h(t[s] ^ t[n], 16)),
                (t[o] = (t[o] + t[s]) >>> 0),
                (t[i] = h(t[i] ^ t[o], 12)),
                (t[n] =
                  (t[n] + ((r[u[e][a + 1]] ^ f[u[e][a]]) >>> 0) + t[i]) >>> 0),
                (t[s] = h(t[s] ^ t[n], 8)),
                (t[o] = (t[o] + t[s]) >>> 0),
                (t[i] = h(t[i] ^ t[o], 7));
            }
            ...
            (c.prototype._compress = function () {
              ...
              for (
                this._nullt ||
                  ((e[12] = (e[12] ^ this._length[0]) >>> 0),
                  (e[13] = (e[13] ^ this._length[0]) >>> 0),
                  (e[14] = (e[14] ^ this._length[1]) >>> 0),
                  (e[15] = (e[15] ^ this._length[1]) >>> 0)),
                  t = 0;
                t < 14;
                ++t
              )
                i(e, n, t, 0, 4, 8, 12, 0),
                  ...
                  i(e, n, t, 3, 7, 11, 15, 6),
                  i(e, n, t, 0, 5, 10, 15, 8),
                  i(e, n, t, 1, 6, 11, 12, 10),
                  i(e, n, t, 2, 7, 8, 13, 12),
                  i(e, n, t, 3, 4, 9, 14, 14);
              for (t = 0; t < 16; ++t)
                this._h[t % 8] = (this._h[t % 8] ^ e[t]) >>> 0;
              for (t = 0; t < 8; ++t)
                  ...
                  55 === this._blockOffset
                    ...
                    : (this._blockOffset < 55
                        ? (0 === this._blockOffset && (this._nullt = !0),
                          ...
                          this.update(
                            c.padding.slice(0, 55 - this._blockOffset)
                          ))
                        : ((this._length[0] -= 8 * (64 - this._blockOffset)),
                          this.update(
                            c.padding.slice(0, 64 - this._blockOffset)
                          ),
                          (this._length[0] -= 440),
                          this.update(c.padding.slice(1, 56)),
                          (this._nullt = !0)),
              ...
              (c.prototype.digest = function (t) {
                this._padding();
                for (var r = new o(32), e = 0; e < 8; ++e)
                  r.writeUInt32BE(this._h[e], 4 * e);
                return r.toString(t);
              }),
              (e.exports = c);
        ...
        function (t, r, e) {
          ...
          function a(t, r) {
            ...
            for (
              ...
              g[e] = o(t.b, 4 * e);
            for (e = 0; e < 12; e++)
              n(0, 8, 16, 24, i[16 * e + 0], i[16 * e + 1]),
                n(2, 10, 18, 26, i[16 * e + 2], i[16 * e + 3]),
                n(4, 12, 20, 28, i[16 * e + 4], i[16 * e + 5]),
                n(6, 14, 22, 30, i[16 * e + 6], i[16 * e + 7]),
                n(0, 10, 20, 30, i[16 * e + 8], i[16 * e + 9]),
                n(2, 12, 22, 24, i[16 * e + 10], i[16 * e + 11]),
                n(4, 14, 16, 26, i[16 * e + 12], i[16 * e + 13]),
                n(6, 8, 18, 28, i[16 * e + 14], i[16 * e + 15]);
          ...
          var p = t("./biginteger").JSBigInt,
            n = (function () {
              for (
                ...
                f.push(t.charCodeAt(r));
              var h = [0, 2, 3, 5, 6, 7, 9, 10, 11],
                c = f.length,
                l = new p(2).pow(64);
              return (
                (a.encode_block = function (t, r, e) {
                ...
                (a.encode = function (t) {
                  var r = (function (t) {
                    ...
                    for (
                      var r = new Uint8Array(t.length / 2), e = 0;
                      e < t.length / 2;
                      ++e
                    )
                      r[e] = parseInt(t.slice(2 * e, 2 * e + 2), 16);
                    return r;
                  })(t);
                  if (0 === r.length) return "";
                  var e,
                    n = Math.floor(r.length / 8),
                    i = r.length % 8,
                    o = 11 * n + h[i],
                    s = new Uint8Array(o);
                  for (e = 0; e < o; ++e) s[e] = f[0];
                  for (e = 0; e < n; e++)
                    s = a.encode_block(r.subarray(8 * e, 8 * e + 8), s, 11 * e);
                  return (
                    0 < i &&
                      (s = a.encode_block(
                        r.subarray(8 * n, 8 * n + i),
                        s,
                        11 * n
                      )),
                    (function (t) {
                ...
                (a.decode_block = function (t, r, e) {
                  ...
                  for (
                    var i = new p(0), o = new p(1), s = t.length - 1;
                    0 <= s;
                    s--
                  ) {
                    var a = f.indexOf(t[s]);
                  ...
                  if (n < 8 && new p(2).pow(8 * n).compare(i) <= 0)
                    throw "Overflow 2";
                  return (
                    r.set(
                      (function (t, r) {
                        ...
                        for (var n = new p(2).pow(8), i = r - 1; 0 <= i; i--)
                          (e[i] = t.remainder(n).toJSValue()),
                            (t = t.divide(n));
                        return e;
                      })(i, n),
                      e
                ...
                (a.decode = function (t) {
                  if (
                    ...
                    (t = (function (t) {
                      for (
                        var r = new Uint8Array(t.length), e = 0;
                        e < t.length;
                        e++
                      )
                        r[e] = t.charCodeAt(e);
                  ...
                  for (var i = new Uint8Array(8 * r + n), o = 0; o < r; o++)
                    i = a.decode_block(
                      t.subarray(11 * o, 11 * o + 11),
                      i,
                      8 * o
                    );
                  return (
                    0 < e &&
                      (i = a.decode_block(
                        t.subarray(11 * r, 11 * r + e),
                        i,
                        8 * r
                      )),
                    (function (t) {
                      for (var r = [], e = 0; e < t.length; ++e)
                        r.push(("0" + t[e].toString(16)).slice(-2));
                      return r.join("");
                    })(i)
                  );
                }),
      ...
      15: [
        function (t, r, e) {
          ...
          function s(t, r) {
            ...
            return null === n || n.length < 2 || 40 < n.length
              ? null
              : 0 === e.data[0] && 20 !== n.length && 32 !== n.length
              ? null
              : {
                  version: e.data[0],
                  program: n,
          ...
          r.exports = {
            ...
            isValidAddress: function (t, r) {
              ...
              return (
                null === e && (e = s((r = "tb"), t)),
                null !== e && n(r, e.version, e.program) === t.toLowerCase()
              );
            },
          };
        },
        ...
        function (t, R, r) {
          (function (t, r) {
            ...
            t.versions.node
              ...
              : i && (n = self);
            var l =
                !n.JS_SHA3_NO_ARRAY_BUFFER && "undefined" != typeof ArrayBuffer,
            ...
            for (
                  ...
                  },
                  {
                    ...
                    createMethod: function (n, i) {
                      var o = h[n],
                        s = y(n, 0, "hex");
                      return (
                        (s.create = function (t, r, e) {
                          return r || e
                            ? new S(n, i, t).bytepad([r, e], o)
                            : _["shake" + n].create(t);
                        }),
              ...
              for (var x = m[E], B = x.bits, k = 0; k < B.length; ++k) {
                ...
                if (
                  (A.push(U),
                  (_[U] = x.createMethod(B[k], x.padding)),
                  "sha3" !== x.name)
                ) {
                  var T = x.name + B[k];
                  A.push(T), (_[T] = _[U]);
            ...
            (S.prototype.update = function (t) {
              if (!this.finalized) {
                ...
                for (
                  ...
                  if (this.reset)
                    for (
                      this.reset = !1, o[0] = this.block, n = 1;
                      n < u + 1;
                      ++n
                    )
                      o[n] = 0;
                  if (r)
                    for (n = this.start; f < a && n < s; ++f)
                      o[n >> 2] |= t[f] << p[3 & n++];
                  else
                    for (n = this.start; f < a && n < s; ++f)
                  ...
                  if (s <= (this.lastByteIndex = n)) {
                    for (
                      this.start = n - s, this.block = o[u], n = 0;
                      n < u;
                      ++n
                    )
                      h[n] ^= o[n];
                ...
                if (r) n = i;
                  ...
                  for (var o = 0; o < t.length; ++o) {
                    ...
                    s < 128
                      ...
                      : ((s =
                          65536 +
                          (((1023 & s) << 10) | (1023 & t.charCodeAt(++o)))),
                        (n += 4));
                  }
                return (n += this.encode(8 * n)), this.update(t), n;
              }),
              (S.prototype.bytepad = function (t, r) {
                for (var e = this.encode(r), n = 0; n < t.length; ++n)
                  e += this.encodeString(t[n]);
                var i = r - (e % r),
                  o = [];
                ...
                function () {
                  ...
                  return (
                    i &&
                      ((t = e[o]),
                      (a += u[(t >> 4) & 15] + u[15 & t]),
                      1 < i && (a += u[(t >> 12) & 15] + u[(t >> 8) & 15]),
                      2 < i && (a += u[(t >> 20) & 15] + u[(t >> 16) & 15])),
                    a
                  );
                }),
            ...
            toHex: function (t) {
              for (var r, e, n = "", i = 0; i < t.length; i++)
                n +=
                  ((r = t[i]),
                  (e = void 0),
                  1 === (e = Math.round(r).toString(16)).length &&
                    (e = "0" + e),
                  e);
              return n;
            },
          ...
          r.exports = {
            ...
            verifyChecksum: function (t) {
              ...
              for (var r = n.keccak256(t.toLowerCase()), e = 0; e < 40; e++)
                if (
                  (7 < parseInt(r[e], 16) && t[e].toUpperCase() !== t[e]) ||
        ...
        function (t, r, e) {
          ...
          r.exports = {
            ...
            verifyChecksum: function (t) {
              ...
              return (
                n.blake2b(n.toHex(r.slice(0, -5)), 5) ===
                n.toHex(r.slice(-5).reverse())
              );
            },
          };
        },
        ...
        function (t, r, e) {
          ...
          r.exports = {
            ...
            verifyChecksum: function (t) {
              var r = o.decode(t);
              return (
                n.sha256Checksum(n.toHex(r.slice(0, -4))) ===
                n.toHex(r.slice(-4))
              );
            },
          };
